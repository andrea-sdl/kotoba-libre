# Archived UI Redesign Note

Last updated: March 8, 2026

This file is kept only as an archive marker for the March 2026 redesign effort.

The original contents described a Tauri, TypeScript, and CSS implementation plan that no longer matches this repository.
